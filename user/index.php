...
<head>
    ...
    <style>
        ...
        .room-card { border: none; border-radius: 20px; transition: all 0.3s ease; overflow: hidden; }
        .room-card:hover { transform: translateY(-5px); }
        .badge-tipe { border-radius: 10px; font-size: 11px; padding: 5px 12px; text-transform: uppercase; font-weight: 600; }
        .btn-booking { border-radius: 12px; font-weight: 600; padding: 10px; }
    </style>
</head>
<body>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.room-card').each(function(i) {
                ...
                setTimeout(() => { $(this).animate({'opacity': '1', 'margin-top': '0px'}, 400); }, 150 * i);
            });
        });
    </script>
</body>
