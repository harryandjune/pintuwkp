...
<head>
    ...
    <style>
        ...
        .form-control { border-radius: 15px; padding: 12px 18px; background-color: #f8f9fa; border: 1px solid #eee; font-size: 14px; }
        .btn-login { border-radius: 15px; padding: 12px; font-weight: 600; background: linear-gradient(135deg, #0d6efd, #0d6efd); border: none; transition: all 0.3s; color: white; }
