...
if (isset($_GET['id']) && isset($_GET['status'])) {
    ...
    if ($status == 'disetujui') {
        ...
        if ($eksekusi) {
            ...
            // Pastikan mengambil kolom tujuan dan keperluan
...
?>
    ...
    <body>
        <div class="status-card">
            ...
            <p class="text-muted small">Armada telah dialokasikan. Detail tujuan dan keperluan sudah dimasukkan ke dalam pesan.</p>
